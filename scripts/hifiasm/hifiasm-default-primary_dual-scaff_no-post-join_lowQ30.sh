#!/usr/bin/env bash
#SBATCH --job-name=hifiasm-default-primary_dual-scaff_no-post-join_lowQ30
#SBATCH -p icelake
#SBATCH -N 1
#SBATCH -c 40
...
# Default primary dual-scaff no post-join 50% lowQ
hifiasm \
    -o "hmaj-default-primary_dual-scaff_no-post-join_lowQ30" \
